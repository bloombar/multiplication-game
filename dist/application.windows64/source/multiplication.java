...
public void keyPressed() {
  ...
  if (state.mode == "question" && keyCode == ENTER_KEY) {
    ...
    speed[0] = speed[0] * 1.25f;
    speed[1] = speed[1] * 1.25f;
    if (state.mode == "question") {
      for (Bubble bubble : state.question.bubbles) {
        bubble.speed[0] = bubble.speed[0] * 1.25f;
        bubble.speed[1] = bubble.speed[1] * 1.25f;
      }
    }
  }
    ...
    speed[0] = speed[0] * 0.75f;
    speed[1] = speed[1] * 0.75f;
    if (state.mode == "question") {
      for (Bubble bubble : state.question.bubbles) {
        bubble.speed[0] = bubble.speed[0] * 0.75f;
        bubble.speed[1] = bubble.speed[1] * 0.75f;
      }
    }
  }
...
class State {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "multiplication" };
    if (passedArgs != null) {
